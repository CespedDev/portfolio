import{a as Et}from"./chunk-KS6ZJ6VA.js";import{d as Ct}from"./chunk-ROAERNMH.js";import{a as nt,d as ot,g as it,k as lt,l as Ot}from"./chunk-KP34SWZQ.js";import{b as xt,c as Tt,e as Mt}from"./chunk-KYHLHVCG.js";import{$ as b,N as J,O as j,R as W,S as L,U as X,W as Z,aa as tt,j as G,k as Y}from"./chunk-IKAGNX4Q.js";import{$a as d,Ab as yt,Cb as q,Eb as S,Fa as O,Fb as vt,Ga as ut,Ha as bt,Hb as H,I as N,Ia as $,J as V,Ja as w,K as st,Ka as y,Kb as K,M as A,O as h,Ob as m,Qa as I,T as ft,Ta as v,U as mt,Ua as C,Ub as p,Vb as Q,Wa as ht,Xa as P,Xb as kt,Ya as B,Za as c,Zb as et,_ as D,_a as s,ab as R,da as z,ga as _,gb as F,hb as _t,jb as x,kb as u,nb as U,pb as T,qa as ct,qb as M,ta as r,xb as k,yb as g,zb as f}from"./chunk-3H7DRUIN.js";var at=(()=>{class e extends Ot{required=m(void 0,{transform:p});invalid=m(void 0,{transform:p});disabled=m(void 0,{transform:p});name=m();_disabled=z(!1);$disabled=K(()=>this.disabled()||this._disabled());onModelChange=()=>{};onModelTouched=()=>{};writeDisabledState(t){this._disabled.set(t)}writeControlValue(t,n){}writeValue(t){this.writeControlValue(t,this.writeModelValue.bind(this))}registerOnChange(t){this.onModelChange=t}registerOnTouched(t){this.onModelTouched=t}setDisabledState(t){this.writeDisabledState(t),this.cd.markForCheck()}static \u0275fac=(()=>{let t;return function(o){return(t||(t=_(e)))(o||e)}})();static \u0275dir=bt({type:e,inputs:{required:[1,"required"],invalid:[1,"invalid"],disabled:[1,"disabled"],name:[1,"name"]},features:[w]})}return e})();var wt=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
